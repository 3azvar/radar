...
public class Speech_zapas extends AppCompatActivity implements RecognitionListener {
...
return txt;
    ...
    private void checkMyPermissions() {
        ...
        if (ContextCompat.checkSelfPermission(Speech_zapas.this, Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions(Speech_zapas.this,
        ...
        switch (requestCode) {
            ...
            case MY_REQUEST_CODE: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(Speech_zapas.this, " shode", Toast.LENGTH_SHORT).show();
                    // getContacts();
                } else {
            ...
            case REQUEST_RECORD_PERMISSION:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(Speech_zapas.this, "Permission Denied!", Toast
                            .LENGTH_SHORT).show();
                }
        }
    }
